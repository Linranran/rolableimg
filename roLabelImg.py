...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None):
        ...
        self.filedock.setFeatures(self.filedock.features() ^ int(self.dockFeatures))
        ...
        edit = action('&Edit Label', self.editLabel,
                      ...
                      enabled=False)
        ####添加
        edit1 = action('&Edit Label', self.editLabel1,
                      '1', 'edit', u'Modify the label of the selected Box',
                      enabled=True)
        edit2 = action('&Edit Label', self.editLabel2,
                      '2', 'edit', u'Modify the label of the selected Box',
                      enabled=True)
        ...
        labelMenu = QMenu()
        addActions(labelMenu, (edit,edit1,edit2, delete))
        #添加
        ...
        self.actions = struct(save=save, saveAs=saveAs, open=open, close=close,
                              lineColor=color1, fillColor=color2,  create=create,
                               createRo=createRo, delete=delete, edit=edit, edit1=edit1,edit2=edit2,   #添加
                              copy=copy,
                              ...
                              beginner=(), advanced=(),
                              editMenu=(edit, edit1,edit2,copy, delete,    #添加
                                        None, color1, color2),
                              beginnerContext=(create, edit,edit1,edit2, copy, delete),  # 添加
                              advancedContext=(createMode, editMode, edit,edit1,edit2, copy,  #添加
        ...
        # defaultPrefdefClassFile=r'D:\软件包\roLabelImg-master\roLabelImg-master\data\predefined_classes.txt'
