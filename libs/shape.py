...
DEFAULT_LINE_COLOR = QColor(255, 255, 255, 0)  #颜色的Alpha通道指定透明效果，0表示完全透明的颜色，而255表示完全不透明的颜色
DEFAULT_FILL_COLOR = QColor(255, 255, 255, 0)
DEFAULT_SELECT_LINE_COLOR = QColor(255, 255, 255,0)  #选中后框的颜色
DEFAULT_SELECT_FILL_COLOR = QColor(0, 128, 255, 0) #选中后填充颜色
DEFAULT_VERTEX_FILL_COLOR = QColor(0, 255, 0, 100)   #默认顶点颜色
DEFAULT_HVERTEX_FILL_COLOR = QColor(255, 0, 0,0)  #选中顶点颜色
